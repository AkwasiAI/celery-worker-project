...
from .orasismarkdown2pdf import MarkdownToPDFConverter
...
class ReportPDFService:
    ...
    def generate_and_upload_pdf(self, 
        ...
        try:
            ...
            try:
                converter.convert(report_sections, output_filename)
                local_path = output_filename
                result['local_path'] = local_path
            except Exception as e:
                logger.error(f"Failed to convert markdown to PDF report: {e}")
